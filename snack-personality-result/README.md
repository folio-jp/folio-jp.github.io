...
カスタムGPTが生成したURLパラメータを受け取り、診断結果をキャラクター、5軸レーダーチャート、上位3タイプ構成、文章、相性として可視化する静的Webページです。診断質問や採点は行いません。
...
ブラウザで `http://localhost:8000/` を開きます。ファイルを直接開くよりHTTPサーバー経由を推奨します。
